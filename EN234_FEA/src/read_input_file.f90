                ...
                !   Read element properties
                    ...
                    do while (.true.)
                        ...
                        if ( strcmp(strpar(1), 'PARAM', 5) ) then
                            ...
                            if ( nstr<4 .or. (ityp(2)/=0) .or. (ityp(3)/=0) .or. (ityp(4)/=0).or.nstr>4 ) then
                                write(IOW,*) '  *** ERROR DETECTED IN INPUT FILE ***'
        ...
        if ( strcmp(strpar(1), 'MESH', 4) ) then
            ...
            do while ( .true. )
                ...
                !   Read element properties
                    ...
                    if (length_element_properties>0) allocate(element_properties(length_element_properties), stat = status)
                ...
                if ( strcmp(strpar(1), 'HISTORY', 7) ) then
                    ...
                    do while (.true.)
                        ...
                        if (ityp(2) /=0.or.nstr<4) then
                            write(IOW,*) ' *** Error in input file ***'
                            write(IOW,*) ' Expecting element set name, face #, '
                            write(IOW,'(A)') ' VALUE/HISTORY/NORMAL or SUBROUTINE,  history/parameter name, or value, values '
                            write(IOW,*) ' Found '
                            write(IOW,*) strin
                            stop
                        endif
